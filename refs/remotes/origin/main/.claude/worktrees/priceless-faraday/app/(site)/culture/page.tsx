...
const posts = [
  {
    ...
    excerpt:     'Why the 12-inch still matters. Format, ritual, and the physics of sound you lose when it goes digital.',
  ...
  },
  {
    ...
    excerpt:     'The full album, front to back. No shuffle, no skip. An argument for listening without shortcuts.',
    tags:        ['Music', 'Practice'],
    date:        'December 2023',
    readTime:    '5 min',
    featured:    false,
  ...
  },
  {
    ...
    excerpt:     'How the Afro-Cuban diaspora built Miami&apos;s sound. This is where it started.',
