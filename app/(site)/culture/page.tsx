...
const posts = [
  {
    ...
    excerpt:     'The 12-inch as object. Format, ritual, and what the physics of sound loses when it goes digital.',
  ...
  },
  {
    ...
    excerpt:     'From Wynwood garages to Coral Gables courtyard sessions. The city has a sound map. This is it.',
  ...
  },
  {
    ...
    excerpt:     'A well-used bag accumulates time differently than new things. On patina, and the objects we stopped buying.',
    tags:        ['Objects', 'Craft'],
    date:        'January 2024',
    readTime:    '6 min',
    featured:    false,
  },
  {
    ...
    excerpt:     'The full album, front to back. No shuffle, no skip. On what you hear when you stop managing the experience.',
    tags:        ['Music', 'Practice'],
    date:        'December 2023',
    readTime:    '5 min',
    featured:    false,
  },
  {
    ...
    issue:       '005',
    title:       'Analog Summer',
    excerpt:     'Shot entirely on 35mm. A long summer in Miami, no filter.',
  ...
  },
  {
    ...
    excerpt:     'How the Afro-Cuban diaspora built Miami&apos;s sound — from Havana to Little Havana and everywhere the signal spread.',
